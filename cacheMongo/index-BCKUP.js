...
module.exports = function (forceRefresh, config) {
   ...
   var connection = mongoose.createConnection('mongodb://localhost:27017/test');
    ...
    /*var db = connection.use();*/
    //mongoose.connect(config.dbName+config.dbUrl); //mongoose.connect(config.dbUrl+config.dbName);
    ...
    function fetch(requestType, url, refresh, callback) {
        ...
        }else {console.log('System should cache all');}
