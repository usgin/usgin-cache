...
({
        ...
        feature: {
            ...
            {  FeatureName: {type: String, es_indexed: true},
                ...
                ActivityEnd: {type: String, es_indexed: true},
                //------ Source Data
...
var mongooseModel = mongoose.model('BoreholeLithInterval', pointSchema);
mongooseModel.createMapping(function(err, mapping){
    console.log("Error :" + err + ".  BoreholeIntervals Mapping is:" + utils.inspect(mapping));
});
