        ...
        feature: {
            ...
            geometry:{
             ...
             /*coordinates: {
                ...
                LatDegree: { type: Number },
                LongDegree: { type: Number }
            },*/
        }
    }
        }
...
var mongooseModel = mongoose.model('ThermalSpring', pointSchema);
mongooseModel.createMapping({

},function(err, mapping){
    // importatnt function for Elastic Geometry Configurateioin
    console.log("Error :" + err + ".  Thermal Sprintg Mapping is:" + utils.inspect(mapping));
});
