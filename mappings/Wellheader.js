...
var mongooseModel = mongoose.model('Wellheader', pointSchema);
mongooseModel.createMapping(function(err, mapping){
    console.log("Error :" + err + ".  WellHeader Mapping is:" + utils.inspect(mapping));
});
module.exports = mongooseModel;
/*var _ = require("underscore");
var mongooseModel;
if(_.indexOf(mongoose.modelNames(), "Wellheader") < 0){
    pointSchema.plugin(mongoosastic);
    mongooseModel = mongoose.model('Wellheader', pointSchema);
    ...
    pointSchema.plugin(mongoosastic);
    mongooseModel = mongoose.model('Wellheader');
}
mongooseModel.createMapping(function(err, mapping){
